...
#Export full data
write.csv(combined_data,file.path(path_hydro,"CalSim3Data_PerfMetrics_2022MED.csv"),row.names=F)
...
cost_data <- read_xlsx(file.path(path_hydro,"SummerFall_WaterCost_2022MED_CFS.xlsx")) %>%
...
write.csv(cost_data_mean,file.path(path_hydro,"WaterCostCalculation_USBR2022MED.csv"))
...
write.csv(data_contract_yr_combined,file.path(path_hydro,"ContractYearExportCalculation_USBR2022MED.csv"))
