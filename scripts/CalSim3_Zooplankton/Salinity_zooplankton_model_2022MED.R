...
salinity_data<-read.csv("converted_salinity_data_SF2022MED.csv")
...
# Export data
write.csv(zoop_model_data_median_imputed_spread,file=paste("zoop_scalar_output_SF2022MED_",Sys.Date(),".csv",sep=""))
