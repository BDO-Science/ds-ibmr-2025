...
dss_data_pull<-function(dss_input="D:\\Summer Flow Action SDM\\2025-03-07 - CalSim3 Output BOR hydrology"){
...
write.csv(AltStatusQuo_data,file.path(path_hydro,"CalSim3_data_SF2022MED_StatusQuo.csv"),row.names=F)
write.csv(AltJune_data,file.path(path_hydro,"CalSim3_data_SF2022MED_June.csv"),row.names=F)
write.csv(AltMaxDS_Even_data,file.path(path_hydro,"CalSim3_data_SF2022MED_MaxDS_Even.csv"),row.names=F)
write.csv(AltMaxDS_Hist_data,file.path(path_hydro,"CalSim3_data_SF2022MED_MaxDS_Hist.csv"),row.names=F)
write.csv(AltMaxWater_data,file.path(path_hydro,"CalSim3_data_SF2022MED_MaxWater.csv"),row.names=F)
write.csv(AltSummer_Even_data,file.path(path_hydro,"CalSim3_data_SF2022MED_Summer_Even.csv"),row.names=F)
write.csv(AltSummer_Even_AltSMSCG_data,file.path(path_hydro,"CalSim3_data_SF2022MED_Summer_Even_AltSMSCG.csv"),row.names=F)
write.csv(AltSummer_Hist_data,file.path(path_hydro,"CalSim3_data_SF2022MED_Summer_Hist.csv"),row.names=F)
write.csv(AltSummerFall_Even_data,file.path(path_hydro,"CalSim3_data_SF2022MED_SummerFall_Even.csv"),row.names=F)
write.csv(AltSummerFall_Hist_data,file.path(path_hydro,"CalSim3_data_SF2022MED_SummerFall_Hist.csv"),row.names=F)
write.csv(AltMaxWater_noSMSCG_data,file.path(path_hydro,"CalSim3_data_SF2022MED_MaxWater_noSMSCG.csv"),row.names=F)
...
#Export full data
write.csv(data_flow_IBMR,file.path(path_hydro,"IBMR_FlowData_DeltaSmelt_SF2022MED_alternatives.csv"),row.names=F)
...
write.csv(data_X2,file.path(path_output,"IBMR_X2_SF2022MED_input.csv"),row.names=F)
write.csv(data_OMR,file.path(path_output,"IBMR_OMR_SF2022MED_input.csv"),row.names=F)
